...
<body>
    ...
    <div class='container heading'>
        <!-- Student Create Form -->
        <form method='post' action='index.php?mod=student&view=studentForm' class='student_form_align' enctype='multipart/form-data' onsubmit='return validateForm()'>
        <h3 class='create_form'>Student Create Form</h3>
            <div class='form-group'>
                <label><b>
                        Firstname:
                    </b><span class='mandatory'>*</span>
                </label><br>
